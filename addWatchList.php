...
<html>
    ...
    <body onload="addGenres('watchlist')">
    	...
    	<form class="general-padding addItem">
    		...
    		<div class="row g-3 align-items-center">
        		...
        		<div class="col-auto">
    				<div class="form-check form-check-inline">
						<input class="form-check-input" type="radio" name="type" id="show" value="show">
			...
			<input class="btn btn-primary"type="submit" name="add" value="Add Movie/Show" required>
    	</form>
